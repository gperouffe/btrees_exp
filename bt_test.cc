...
int main(int argc, char* argv[])
{
    ...
    out << "    cout << setw(8) << \"M,\" << setw(11) << \"Insert,\" << setw(11) << \"Find,\" << setw(11) << \"Delete,\" << setw(11) << \"Node size\" << endl;" << endl;
    
    for(int i = 16; i <= Mmax; ++i)
    {
            out << "    BT" << i << " bt" << i << ";" << endl;
            out << "    for(int j = 0; j < " << reps <<"; ++j){" << endl;
            out << "        bt" << i << ".clear();" << endl;
            ...
            out << "cout << setw(11) << " << sizeof(long) * i << " << endl;" << endl;
            out << "    }" << endl;
    }
